...
public class Constants
{
    ...
    {
        private static final double[] distance     = {0.71, 1.85, 2.00, 2.86, 3.00}; // < Single Wheel Values I Double Wheel Values > {0.64, 0.82, 1.20, 1.36, 1.58, 1.85, 2.00, 2.86, 3.00};
        private static final double[] shooterTicks = {640,  740,  760,  900,  920};  // < Single Wheel Values I Double Wheel Values > {540, 540, 560, 580, 600, 620, 640, 740, 760};
