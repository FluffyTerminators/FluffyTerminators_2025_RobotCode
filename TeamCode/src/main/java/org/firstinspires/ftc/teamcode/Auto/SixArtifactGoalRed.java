...
@Autonomous(name = "Z_old_Red Goal 6 Artifact")
@Configurable // Panels
public class SixArtifactGoalRed extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(120.500, 127.000, Math.toRadians(217)));
    ...
    public static class Paths {
        ...
        public PathChain StartLaunch;
        public PathChain LaunchCollect;
        public PathChain Collect;
        public PathChain CollectLaunch;
    ...
    public int autonomousPathUpdate() {
        ...
        {
            case 0:
                follower.followPath(paths.StartLaunch);
                pathState = 1;
                shotsToTake = 3;
            ...
            case 2:
                if (!follower.isBusy())
                {
                    ...
                    follower.followPath(paths.LaunchCollect);
                    pathState = 3;
                }
                break;
            ...
            case 6:
                if (!follower.isBusy())
                {
                    follower.followPath(paths.CollectLaunch);
                    shotsToTake = 3;
